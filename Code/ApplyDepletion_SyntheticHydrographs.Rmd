...
This script is intended to apply the fractional streamflow depletion (`Qf`) calculated in `CalculateDepletion.R` to long-term hydrologic data from a gage. Instead of picking 'dry', 'average', and 'wet' years, the hydrograph is represented as the Q10, Q50, and Q90 for the gage.
