---
title: "Apply calculated depletion to a gage"
output: rmarkdown::github_document
---

# Overview

This script is intended to apply the fractional streamflow depletion (`Qf`) calculated in `CalculateDepletion.R` to long-term hydrologic data from a gage. 
